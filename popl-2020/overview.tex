...
With \toolname, however, all we need to do is run this command (denoting our old list type as \lstinline{Old.list} and our new list type as \lstinline{New.list}): % TODO adapted for now
