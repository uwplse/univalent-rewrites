...
This produces a refactored proof script (here and throughout, we use $\codeauto{light blue}$ to denote
...
\citet{robert2018} describes the challenges of refactoring tactics directly in detail.
