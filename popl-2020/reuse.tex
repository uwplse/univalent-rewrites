...
The goal of a proof repair tool like \toolname is, in essence, to define a transport method that
...
after that, we can remove the old type and all of the functions and proofs about it. %, and replace them all with
