...
\end{lstlisting}
\toolname further requires that the equivalences it supports can be described by a particular configuration that we will define in Section~\ref{sec:configurable}.
...
This is true whenever it is possible to express those changes as equivalences between \textit{refinements} ($\Sigma$ types).
