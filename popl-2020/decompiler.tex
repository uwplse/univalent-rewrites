...
works (applying the proof term with the \lstinline{apply} tactic), the result is often unreadable.
...
For now, massaging the output if desired is left to the proof engineer. % TODO does this belong in future work?
