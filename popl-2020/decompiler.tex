...
\inferrule[Rewrite]
  { \Gamma \vdash p_x \Rightarrow p }
  { \Gamma \vdash \mathrm{Elim}(\mathtt{eq\_sym}\ H,\ P) \{ x,\ p_x,\ y \} \Rightarrow \mathrm{Rewrite} \rightarrow H.\ p }
...
\inferrule[Pose]
  { \Gamma,\ n := t : T \vdash b \Rightarrow p }
