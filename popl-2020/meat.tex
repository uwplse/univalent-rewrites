...
\subsection{Insight 1: Reducing the Problem}
...
\subsection{Insight 2: The Configurable Transformation}
...
\subsection{Insight 3: The Decompiler}
...
Figure~\ref{fig:final} shows the configurable proof term transformation at the heart of all of this.
The transformation is parameterized over two equivalent types \A and \B (rule \lstinline{Equivalence}).
