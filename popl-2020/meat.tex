...
\begin{enumerate}
\item Something relating the eliminator and the eta-expanded identity function
\item Something relating the eliminator and the constructors to reflexivity
\end{enumerate}
