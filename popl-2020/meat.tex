...
\mprset{flushleft}
\small
\hfill\fbox{$\Gamma$ $\vdash$ $t$ $\Uparrow$ $t'$}\vspace{-0.2cm}\\
...
with dependent constructors (respectively eliminators) of \B will preserve equality up to transport for those particular subterms.
