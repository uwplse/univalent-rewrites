...
\begin{lstlisting}
DepConstr(0, New.list T) : New.list T := Constr(1, New.list T). (* New.nil in Coq *)
DepConstr(1, New.list T) (t : T) (l : New.list T) : New.list T := Constr(0, New.list T) t l. (* New.cons in Coq *)
\end{lstlisting}
