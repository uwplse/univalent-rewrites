...
The first ports functions and proofs from the input type to the ornamented type at \textit{some} index,
...
Implementing the first configuration was straightforward.
...
like the eliminator over \lstinline{nat}:
