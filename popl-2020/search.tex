...
The definition of binary numbers (Figure~\ref{fig:nattobin}) comes from the Coq standard library.
A binary number is either zero or a positive binary number. A positive binary number
