...
The search procedure took less than a week for us to implement, and supported the user through porting many % how many?
functions and proofs across similar relations between many % how many?
different tuples and corresponding named records.
how many LOC?
techniques from pumpkin patch and devoid.
