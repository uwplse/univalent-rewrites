...
The user used a few different configurations from DEVOID, but most commonly the user wanted a way to translate
anonymous nested tuples like this:
...
TODO
\end{lstlisting}
write this proof over the new specification:

\begin{lstlisting}
TODO
\end{lstlisting}
and then automatically port that proof back to a proof of the original specification:
