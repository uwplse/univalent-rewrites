...
So far, the proof engineer has used at least three automatic configurations and no manual configurations.
...
and is the configuration that the proof engineer uses most often.
