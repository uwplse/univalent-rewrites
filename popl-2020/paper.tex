...
\begin{abstract}
We describe a new approach to automatically repairing broken proofs in response to changes in type definitions in the Coq proof assistant.
...
Ben Kushigian, and the anonymous reviewers for feedback.
We thank Nicolas Tabareau for helpful discussions about definitional equality.
...
Gus Smith, and Bill Zorn for thoughts on e-graph integration.
We thank Valentin Robert for feedback on tool usability.
We thank all of the Coq developers for frequent and efficient feedback on plugin APIs for tool implementation.
