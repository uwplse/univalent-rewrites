...
\begin{enumerate}
\item While there are many ways proofs need to be repaired, one common need is respond to a changed type definition.
In this space, existing tools support very limited classes of changes like non-structural changes~\cite{pumpkinpatch} or a predefined set
...
\begin{enumerate}
\item supports changes in types informed by proof engineers and not supported by other repair tools, and
