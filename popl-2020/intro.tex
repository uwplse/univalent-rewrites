...
\end{enumerate}
Our progress towards each of these challenges leverages a corresponding key insight (Section~\ref{sec:key}): % TODO dan comment
...
These insights informed our design of \toolname (Section~\ref{sec:overview}), a plugin for Coq 8.8.
\toolname combines a configurable program transformation over proof terms (Section~\ref{sec:meat}) % TODO doesn't quite match current organization
