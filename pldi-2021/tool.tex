...
Section~\ref{sec:discussion} elaborates on some remaining challenges and our plans to address them. % in the future.
...
by breaking them into parts and reasoning separately about the projections~\circled{15}. %smartelim.ml
...
than those found in Coq. \textbf{Decompile} includes additional logic to reason about these tactics~\circled{11}. % decompiler.ml
