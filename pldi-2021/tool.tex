...
we encounter in the course of running the transformation~\circled{14}. % TODO caching.ml
We also added a cache to tell \toolname not to $\delta$-reduce certain terms~\circled{14}.
...
We added informative error messages~\circled{22} to help the proof engineer distinguish between user errors and bugs. % TODO link to errors
...
We provide more nuanced comparisons to these and more in Section~\ref{sec:related}.}
\vspace{-0.5cm}
\label{fig:changes}
\end{table*}
