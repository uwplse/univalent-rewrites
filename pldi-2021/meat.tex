...
\end{lstlisting}
\toolname can port proofs across the equivalence between this type and \lstinline{list T}~\circled{3}. % Example.v
...
in the form of explicit annotations~\circled{5}.
