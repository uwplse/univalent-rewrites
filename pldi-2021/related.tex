...
However, this relies on proof obligations from the proof engineer beyond those imposed by \toolname,
...
and it includes neither search procedures for equivalences nor tactic script generation, unlike \toolname.
