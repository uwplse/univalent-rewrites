...
to named records.
Some examples of this can be found in the proof engineer's repository~\circled{18}. % TODO aux material %\footnote{\url{https://github.com/Ptival/saw-core-coq/tree/dump-wip}} TODO note in guide it got a bit abandoned because proof engineer got stuck in france...
...
We then showed that the ported proofs hold over fast binary addition.
...
N.peano_rect_succ : $\forall$ P pO pS n,(@\vspace{-0.04cm}@)
  ...
  pS n (N.peano_rect P pO pS n).(@\vspace{-0.04cm}@)
\end{lstlisting}
%
%\begin{lstlisting}
