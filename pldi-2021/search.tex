...
The same file~\circled{3} goes on to port functions and proofs to vectors of a \textit{particular} length, 
...
but they most often used an automatic configuration for porting anonymous tuples produced by their compiler
to named records.
Some examples of this can be found in their repository~\circled{18}. % TODO aux material %\footnote{\url{https://github.com/Ptival/saw-core-coq/tree/dump-wip}} TODO note in guide it got a bit abandoned because proof engineer got stuck in france...
