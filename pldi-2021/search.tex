...
The resulting functions guaranteed preservation of the behavior over \lstinline{Old.Term} before the change.
...
We used \toolname to support this change in \lstinline{constr\_refactor.v}.
