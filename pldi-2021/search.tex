...
The suggested tactics were helpful for writing proofs
...
The development time savings were on the order of minutes.
...
manual configuration, and so did not yet save development time.
...
In contrast, we were not able to make the corresponding change manually, but two expert proof engineers we consulted were able to make this
change in 10 and 35 minutes, respectively.
More automation is needed to bring returns on investment for experts in this use case.
