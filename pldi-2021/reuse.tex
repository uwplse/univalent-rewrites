...
\end{lstlisting}
To give some intuition for what kinds of changes can be described by type equivalences, we describe two of the changes 
from Table~\ref{fig:changes} below.
...
TODO explain that configurations always induce equivalences, though not always in ways suitable for repair
