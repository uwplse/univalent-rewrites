...
notation.\footnote{The notation should be interpreted in a metatheory with \textit{univalence}---a property that Coq lacks,
and that makes it possible to define equality up to transport---or it should be approximated in Coq.
The formal details of equality up to transport in a univalent theory are in \citet{univalent2013homotopy}, and an approximation in Coq is in \citet{tabareau2017equivalences}.}
