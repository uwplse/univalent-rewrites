...
This is implemented in \toolname\footnote{Name changed for double-blind.} (Configurable Approach to Repairing \& Refactoring Outdated Tactics), a proof repair plugin for Coq 8.8 that is available on Github.\footnote{Link withheld for double-blind. See auxiliary material.}
...
\begin{enumerate}
\item \toolname configures the proof term transformation, either:
\begin{enumerate}
