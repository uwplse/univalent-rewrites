...
Table~\ref{fig:changes} shows that \toolname can support a flexible class of changes relative to other proof refactoring and repair tools 
within a unified framework (see Section~\ref{sec:related} for more discussion of related tools).
